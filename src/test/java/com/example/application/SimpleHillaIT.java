...
public class SimpleHillaIT extends BrowserTestBase {

    @BeforeEach
    public void setup() throws Exception {
        // Open the application
        getDriver().get("http://localhost:8080/hilla-hello-world");
    }
    ...
    public void clickButton() {
        ...
        // Check that text of the button is "Hilla, say hello"
        Assertions.assertEquals("Hilla, say hello", button.getText());
    }
